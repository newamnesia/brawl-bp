...
export const AIM_REACTION_TIERS: Record<AimReactionTier, {
  ...
  legendary: { label: "传奇", dodgesProjectiles: true, seconds: { high: 0.36, mid: 0.43 }, joystickRadiusRatio: 0.70, joystickDragSpeed: 370, joystickDragExtraSeconds: 0.08 },
  master: { label: "Pro", dodgesProjectiles: true, seconds: { high: 0.27, mid: 0.34 }, joystickRadiusRatio: 0.45, joystickDragSpeed: 480, joystickDragExtraSeconds: 0.08 },
};
